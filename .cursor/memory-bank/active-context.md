...
- **Key files:** `app/page.tsx`, `app/layout.tsx`, `components/LeaderboardClient.tsx`, `components/LeaderboardRow.tsx`, `lib/mockUsers.ts`, `lib/leaderboard.ts`, `lib/constants.ts`, `lib/types.ts`, `lib/utils.ts`, `e2e/leaderboard.spec.ts`, `playwright.config.ts`.
