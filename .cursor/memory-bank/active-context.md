...
- **Key files:** `app/page.tsx`, `app/layout.tsx`, `components/LeaderboardClient.tsx`, `components/LeaderboardRow.tsx`, `components/Spinner.tsx`, `lib/mockUsers.ts`, `lib/leaderboard.ts`, `lib/constants.ts`, `lib/types.ts`, `lib/utils.ts`.
